...
public abstract class PermissibleInjector
{
	 ...
	 *
	 * @param player
	 *            The player to have {@code permissible} injected into
	 * @param permissible
	 *            The permissible to inject into {@code player}
	 * @return the old permissible if the injection was successful, otherwise null
	 * @throws NoSuchFieldException
	 *             when the permissions field could not be found in the Permissible
